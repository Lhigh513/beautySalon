    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel-body">
                <button id="btn-add" type="button" class="btn btn-info">添加员工信息</button>
                <button id="btn-edit" type="button" class="btn btn-warning">修改员工信息</button>
                        ...
                        <table width="100%" class="table table-striped table-bordered table-hover" id="list">
                            ...
                            <c:forEach  items="${employee}" var="employee">
                                <tr>
                                    ...
                                    <td><c:out value="${employee.roleName}"></c:out></td>
                                </tr>
                            </c:forEach>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select  id="roleName" class="form-control">
                                            <c:forEach  items="${roleName}" var="roleName">
                                                <option class="form-control"><c:out value="${roleName}"></c:out></option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </form>
        ...
        $(document).ready(function() {
            ...
            $('#btn-edit').click( function () {
                ...
                if(rowData.length!=0){
                    ...
                    $("#myModal #roleName").val(rowData[0][2]);
                }else{
            ...
            $('#btn-submit1').click(function () {
                    ...
                    var roleName=$("#myModal #roleName").val()
                    data[0]=id
                    data[1]=name
                    data[2]=roleName
                    $.ajax({
                        type:"post",
                        url:"/beautySalon/admin/editEmployee.do",
            ...
            $('#btn-submit2').click(function () {
                    ...
                    var roleName = $("#myModal1 #roleName").val()
                    data[0]=id
                    data[1]=name
                    data[2]=roleName
                    $.ajax({
                        type:"post",
                        url:"/beautySalon/admin/addEmployee.do",
                        contentType :"application/json",
                        data: JSON.stringify(data),
                        success:function () {
                            resetForm();
            ...
            /**$('#btn-del').click(function () {
                    ...
                    if(rowData.length==1){
                        layer.msg('确定删除该记录吗?',{time:0,btn:['确定','取消'],yes:function () {
                                ...
                                $.ajax({
                                    type : "post",
                                    url : "/beautySalon/admin/deleteEmployee.do",
                                    contentType :"application/json ",
                                    data:JSON.stringify(data),
                                    success : function() {
